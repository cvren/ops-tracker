...
export default async function TemplatesPage() {
  ...
  if (context.membership.role !== WorkspaceRole.ADMIN) {
    return (
      <div className="space-y-8">
        <PageHeader
          eyebrow="Templates"
          title="Template and recurring controls are admin-managed."
          description="Members and viewers keep using task queues and task detail. Repeat-work setup stays admin-first in M3.3."
        />
        <Panel className="space-y-3">
          ...
          <h2 className="text-2xl font-semibold text-ink">
            Repeat-work setup is restricted to workspace admins.
          </h2>
          <p className="text-sm text-ink/70">
            Ask an admin to create or run recurring work. Generated tasks still
            appear in the shared task queues once they are created.
          </p>
        </Panel>
      </div>
    );
